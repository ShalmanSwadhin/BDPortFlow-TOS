...
def test_open_truck_booking_from_dashboard(login_page, dashboard_page, truck_appointment_page, env):
    ...
    assert dashboard_page.is_dashboard_loaded(), 'Dashboard sidebar should be visible after login.'

    dashboard_page.open_truck_booking()
    assert truck_appointment_page.is_module_loaded(), 'Truck booking module should load after navigation.'
